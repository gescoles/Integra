              ...
              <div key={p.id} className="flex items-center justify-between gap-3 rounded-lg bg-white px-3 py-2.5">
                ...
                <div className="flex shrink-0 gap-2">
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded-lg bg-[#2F6FED] px-2.5 py-1.5 text-xs font-semibold text-white hover:bg-[#255ed1]"
                  >
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex shrink-0 gap-1">
                  <button
                    ...
                    className="rounded-lg p-1.5 text-slate-400 hover:bg-slate-100 hover:text-[#2F6FED]"
                  >
