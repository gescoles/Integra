            ...
            <form ref={formRef} action={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input name="tipologia" defaultValue={convenio?.tipologia ?? ""} className="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm outline-none focus:border-[#2F6FED]" />
                </div>
                <div>
                  <label className="mb-1.5 block text-sm font-semibold text-slate-700">{translate(locale, "practicas.estadoAcuerdo")}</label>
                  <input name="estadoAcuerdo" defaultValue={convenio?.estadoAcuerdo ?? ""} className="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm outline-none focus:border-[#2F6FED]" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input name="periodo" defaultValue={convenio?.periodo ?? ""} className="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-sm outline-none focus:border-[#2F6FED]" />
                </div>
                <div>
