...
import { crearCertificacion, actualizarCertificacion, obtenerCatalogoPorCategoria, obtenerCertificacion } from "./actions";
...
export function CrearCertificacionModal({
  ...
  useEffect(() => {
    ...
    obtenerCatalogoPorCategoria(categoria).then((lista) => {
            ...
            {cargando ? (
              ...
              <form action={handleSubmit} className="flex-1 space-y-4 overflow-y-auto px-6 py-5">
                ...
                <div>
                  ...
                  <select name="categoria" required value={categoria} onChange={(e) => setCategoria(e.target.value)} className={inputClass}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input name="cursoAcademico" required defaultValue={datos?.cursoAcademico ?? cursoAcademicoCentro ?? ""} placeholder="Ej. 2025-2026" className={inputClass} />
                  </div>
                  <div>
                    <label className="mb-1.5 block text-sm font-semibold text-slate-700">
