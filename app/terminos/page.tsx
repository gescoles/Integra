  ...
  return (
    <LegalLayout titulo="Términos de servicio" actualizado="agosto de 2026">
      <p>
        ...
        Integra, plataforma digital destinada a facilitar la gestión,
        organización y coordinación de determinados procesos internos de
        centros educativos.
      </p>
      <p>
        El acceso o utilización de Integra implica la aceptación de estos
      ...
      <p>
        Integra pone a disposición de centros educativos una plataforma
      ...
      <p>
        Los usuarios deberán utilizar Integra de forma responsable y
      ...
      <p>
        Integra podrá actuar como proveedor tecnológico y, cuando
      ...
      <p>
        Integra procurará mantener la plataforma disponible de manera
      ...
      <p>
        Integra podrá actualizar o modificar determinadas funcionalidades
      ...
      <p>
        ...
        y demás componentes propios de Integra están protegidos por la
      ...
      <p>
        Integra podrá suspender temporalmente el acceso a una cuenta cuando
